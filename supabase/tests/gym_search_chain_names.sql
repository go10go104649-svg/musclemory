...
do $$ declare q text; begin
 ...
 if exists(select 1 from public.search_gym_stores('試験市')) or exists(select 1 from public.search_gym_stores('試験駅')) then raise exception 'Location scope leaked'; end if;
