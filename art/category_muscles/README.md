...
Rebuild with Blender 4.5.3: run tool/bench_press/make_base.py first, then tool/render_category_muscles.py. SETKEEP_ART_WORK selects the scratch folder containing base.blend. SETKEEP_CATEGORIES optionally selects comma-separated render names. Output is assets/category_muscles/*.png.
